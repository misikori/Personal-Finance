...
public interface IBudgetService
{
    ...
    /// </summary>
    Task<bool> HasSufficientFundsAsync(string username, decimal amount, string currency);

    /// <summary>
    /// Deducts amount from user's budget when buying stocks
    /// Returns false if insufficient funds
    /// </summary>
    Task<bool> DeductFromBudgetAsync(string username, decimal amount, string currency);

    /// <summary>
    /// Adds amount to user's budget when selling stocks
    /// </summary>
    Task<bool> AddToBudgetAsync(string username, decimal amount, string currency);
}
